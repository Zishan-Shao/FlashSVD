...
if __name__ == "__main__":
    ...
    # --------------------------- 9. patch to Flash-FW ----------------------------
    for i, hf_layer in enumerate(model.bert.encoder.layer):        # SAME stored layers
    ...
    # after you patch model.bert.encoder.layer…
    # baseline = summarize_dense_vs_lowrank(model)
    # print(f"True persistent low-rank model storage: {baseline:.1f} MiB")
    ...
    # # print the summary of the memory to see which part takes the most space
