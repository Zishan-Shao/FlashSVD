...
# CUDA_VISIBLE_DEVICES=3,4,5,6,7 SVD_DTYPE=fp32 SVD_COMPUTE_FP32=1 SVD_VERIFY=1 PRINT_SUMMARY=0 MAX_EVAL_SAMPLES=10 MAX_EVAL_BATCHES=5 CHUNK_SIZE=256 python profile_svd_kv_llama_single_head.py
