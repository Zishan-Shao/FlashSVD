...
# CUDA_LAUNCH_BLOCKING=1 TORCH_USE_CUDA_DSA=1 python3 profile_asvd_accum.py --decode-mem --asvd --compare-dense --decode-batch 2 --prompt-len 64 --decode-curve 128,256 --rank-ratio-attn 0.5 --rank-ratio-mlp 0.5
