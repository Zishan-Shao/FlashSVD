...
def flashsvd_attn_decode_packed(
    ...
    *,
    ...
    Notes:
      ...
      - vk_resident=True loads Vk0/Vk1 once per program (requires BR==R for best effect).
    """
    Pq_q = f.Pq
    Pk, Pv = f.Pk, f.Pv
    Vq, Vk, Vv = f.Vq, f.Vk, f.Vv
    ...
    # Vk residency requires BR==R for best effect; we can force br = R when enabled.
    if vk_resident:
        br_eff = R
        vk_res = 1
    else:
