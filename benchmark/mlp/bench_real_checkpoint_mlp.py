...
def main() -> int:
    ...
    ap.add_argument(
        "--backends",
        type=str,
        default="baseline,auto,flashsvd_mlp_dual_split_prod,flashsvd_mlp_dual_split_triton_pcat_s,flashsvd_mlp_dual_split_exact_legacy,flashsvd_mlp_dual_split_triton_v1,flashsvd_mlp_dual_split_triton_v2,flashsvd_mlp_dual_split_triton_v2_sm80,flashsvd_mlp_dual_split_triton_v3",
