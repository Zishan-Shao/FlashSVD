...
def _configure_mode(
    ...
    *,
    ...
    if mode == "baseline":
        ...
        _set_env("FLASH_SVD_USE_CUTLASS_ROPEATTN", "0")
        ...
        _set_env("FLASH_SVD_FFN_BACKEND", "flashsvd_mlp_dual_split_exact_legacy")
        return
    ...
    if mode == "flash":
        ...
        _set_env("FLASH_SVD_USE_CUTLASS_ROPEATTN", "1" if enable_cutlass_rope_attn else "0")
...
def main() -> int:
    ...
    ap.add_argument(
        "--legacy_backend",
        type=str,
        default="flashsvd_mlp_dual_split_exact_legacy",
        help="Canonical MLP backend name; old aliases remain accepted.",
    )
    ap.add_argument(
        "--test_backend",
        type=str,
        default="flashsvd_mlp_dual_split_triton_v2_sm80",
        help="Canonical MLP backend name; old aliases remain accepted.",
    )
    ...
    prev_env = {
        ...
        "FLASH_SVD_USE_CUTLASS_ROPEATTN": os.getenv("FLASH_SVD_USE_CUTLASS_ROPEATTN"),
    ...
    try:
        ...
        for label, backend, dense_cache in modes:
            _configure_mode(
                ...
                enable_cutlass_rope_attn=bool(args.cutlass_ropeattn) if label != "baseline" else False,
