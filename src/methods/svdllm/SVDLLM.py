...
CUDA_VISIBLE_DEVICES=2 python methods/svdllm/SVDLLM.py --model openlm-research/open_llama_7b --model_path original --step 4 --model_seq_len 2048 --eval_batch_size 2


# Whitened/compressed:
CUDA_VISIBLE_DEVICES=6 python methods/svdllm/SVDLLM.py --model openlm-research/open_llama_7b --model_path "./openlm_research_open_llama_7b_whitening_only_0.8.pt" --step 4 --model_seq_len 2048 --eval_batch_size 4
...
CUDA_VISIBLE_DEVICES=7 python methods/svdllm/SVDLLM.py --model openlm-research/open_llama_7b --model_path ./jeffwan_llama_7b_hf_whitening_only_0.4.pt --step 4 --model_seq_len 2048 --eval_batch_size 4
